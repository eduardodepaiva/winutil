...
- **Restarts**: Scheduled updates will be downloaded automatically, but there will be a notification before installation. This prevents Windows 11 from forcing unexpected restarts while a user is logged in.
