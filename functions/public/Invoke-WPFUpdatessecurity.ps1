function Invoke-WPFUpdatessecurity {
    ...
    Write-WinUtilLog -Component "Updates" -Message "Configuring automatic updates to download and notify before installation, in order to avoid unexpected restarts."
